...
class Customers:
    def __init__(self,root):
        ...
        #===========================CUSTOMER REFERNCE NUMBER==========================================
        lbl_cust_ref=Label(labelframeleft,text="Customer Ref:",font=("arial",12,"bold"),padx=2,pady=6)
        lbl_cust_ref.grid(row=0,column=0,sticky=W)
        entry_ref=Entry(labelframeleft,textvariable=self.var_ref,font=("arial",13,"bold"),width=29,state="readonly")
        ...
        txtcname=Entry(labelframeleft,textvariable=self.var_cust_name,font=("arial",13,"bold"),width=29)
        ...
        txtPostCode=Entry(labelframeleft,textvariable=self.var_post,font=("arial",13,"bold"),width=29)
        ...
        txtMobile=Entry(labelframeleft,textvariable=self.var_mobile,font=("arial",13,"bold"),width=29)
        ...
        txtEmail=Entry(labelframeleft,textvariable=self.var_email,font=("arial",13,"bold"),width=29)
        ...
        combo_id["value"]=("Aadhar card","Pan Card","Driving License","Passport")
        combo_id.current(0)
        ...
        txtIdnumber=Entry(labelframeleft,textvariable=self.var_id_number,font=("arial",13,"bold"),width=29)
        ...
        Table_Frame.place(x=435,y=80,width=860,height=490)
        ...
        Details_Table.place(x=0,y=50,width=830,height=350)
